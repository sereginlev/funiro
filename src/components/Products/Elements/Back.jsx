...
import styles from 'scss/modules/Products/Elements/Back.module.scss';

import { addItem, decrement } from 'redux/slices/cartSlice';
...
function Back({ ...product }) {
	...
	return (
		<div className={styles.back}>
			<button className={styles.button} type='button' onClick={() => dispatch(addItem({ ...product }))}>Add to cart</button>

			<div className={styles.actions}>
				<button className={styles.block} type='button' onClick={() => dispatch(decrement({...product}))}>
